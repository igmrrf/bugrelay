...
module.exports = {
  ...
  completeness: {
    ...
    requiredModels: ["User", "BugReport", "Company", "Comment", "Application"],
  ...
  cicd: {
    ...
    triggers: {
      ...
      codeChanges: ["backend/**/*.go", "backend/go.mod", "backend/go.sum"],

      // File patterns that should trigger validation
      docChanges: ["docs/**", ".github/workflows/documentation.yml"],
    },
