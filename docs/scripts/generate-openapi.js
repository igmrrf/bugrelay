              ...
              content: {
                'application/json': {
                  schema: {
                    type: 'object',
                    properties: {
                      message: { type: 'string', example: 'BugRelay API v1 is running' },
  ...
  async generateSchemas() {
    ...
    this.spec.components.schemas = {
      ...
      CreateBugRequest: {
        ...
        properties: {
          ...
          description: { 
            type: 'string', 
            minLength: 10,
            example: 'When I try to click the login button on my mobile device, nothing happens. This issue occurs on both iOS and Android.'
          },
          application_id: { 
            type: 'string', 
            format: 'uuid',
      ...
      AuditLog: {
        ...
        required: ['id', 'action', 'resource', 'details', 'user_id', 'created_at']
      },
      ...
      User: {
        ...
        required: ['id', 'email', 'display_name', 'auth_provider', 'is_email_verified', 'is_admin', 'created_at', 'updated_at']
      }
    };
  }
  ...
  addBugEndpoints() {
    ...
    this.spec.paths['/api/v1/bugs'] = {
      get: {
        ...
        description: 'Retrieve a paginated list of bug reports with optional filtering',
        tags: ['Bugs'],
        parameters: [
          {
            name: 'page',
          ...
          },
          {
            ...
            schema: { type: 'string', enum: ['open', 'reviewing', 'fixed', 'wont_fix'] }
          },
          {
            name: 'priority',
            in: 'query',
          ...
          },
          {
            ...
            schema: { type: 'string', enum: ['created_at', 'vote_count', 'updated_at'], default: 'created_at' }
          },
          {
            name: 'order',
            in: 'query',
      ...
      post: {
        ...
        description: 'Submit a new bug report. Authentication is optional but recommended.',
        tags: ['Bugs'],
        security: [{ BearerAuth: [] }, {}],
        requestBody: {
          required: true,
  ...
  addCompanyEndpoints() {
    ...
    this.spec.paths['/api/v1/companies/{id}/verify'] = {
      post: {
        ...
        description: 'Complete the company verification process using the token from email',
        tags: ['Companies'],
        security: [{ BearerAuth: [] }],
        parameters: [
          {
