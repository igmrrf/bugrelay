        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  <label className="text-sm font-medium">Auto-respond to new bugs</label>
                  <p className="text-xs text-muted-foreground">
                ...
                <Switch
                  ...
                  onCheckedChange={(checked: boolean) => handleInputChange('autoRespond', checked)}
                />
              </div>

              {formData.autoRespond && (
                <div className="space-y-2">
                  <label htmlFor="responseTemplate" className="text-sm font-medium">
                  ...
                  />
                  <p className="text-xs text-muted-foreground">
                    This message will be automatically posted as a comment on new bug reports
                  </p>
                </div>
              )}
            </CardContent>
